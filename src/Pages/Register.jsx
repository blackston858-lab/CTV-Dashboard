        ...
        <div className='bg-[rgb(229,252,254)] min-h-screen flex items-center justify-center' >
            ...
            <div className='bg-[rgb(233,245,247)] w-[600px]   rounded-3xl items-center justify-center flex flex-col border-2 border-white'>
                <div className='justify-center flex flex-col items-center'>
                  ...
                  <h1 className='text-[30px]'> <span className='text-[rgb(15,200,202)]'>Register</span> to Codes Vista PMS</h1>
                </div>
               ...
               {/* placeholder 1*/}
                <div className='pt-5'>
                 ...
                 <input type="text" placeholder='user name '  className='w-96 p-2 rounded-2xl'/>
                </div>

                {/* placeholder 2 */}
                <div className='pt-5 '>
                 <h1 className='text-[15px] text-gray-700'>Email Address</h1>
                 <input type="text" placeholder='name@gmail.com'  className='w-96 p-2 rounded-2xl'/>
                </div>

                <div className='pt-5 '>
                 <h1 className='text-[15px] text-gray-700'>Phone No</h1>
                 <input type="text" placeholder='+92'  className='w-96 p-2 rounded-2xl'/>
                </div>

                <div className='pt-5 '>
                 <h1 className='text-[15px] text-gray-700'>Password</h1>
                 <input type="text" placeholder='Password  '  className='w-96 p-2 rounded-2xl' />
                </div> 
                ...
                <div className='py-2 px-44 rounded-2xl bg-[rgb(37,136,157)] mt-4 text-white'>
                 ...
                 <h1 className='pr-56 text-[12px] pt-4 pb-5'>Already have an account? <span className='text-gray-500'>Login</span></h1>
